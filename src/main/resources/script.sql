...
CREATE  TABLE IF NOT EXISTS USERS (ID INT NOT NULL AUTOINCREMENT, NAME VARCHAR(255),PRIMARY KEY (ID)) ENGINE=InnoDB;
CREATE  TABLE IF NOT EXISTS TASKS (ID INT NOT NULL AUTOINCREMENT, NAME VARCHAR(255),PRIMARY KEY (ID)) ENGINE=InnoDB;
CREATE  TABLE IF NOT EXISTS EVENTS (ID INT NOT NULL AUTOINCREMENT, NAME VARCHAR(255),PRIMARY KEY (ID)) ENGINE=InnoDB;
...
CREATE  TABLE IF NOT EXISTS LEADERBOARD (II INT NOT NULL AUTOINCREMENT, USER_ID INT NOT NULL, POINTS INT(10), FOREIGN KEY (USER_ID) REFERENCES USERS(ID)) ENGINE=InnoDB;
CREATE  TABLE IF NOT EXISTS NOTIFICATIONS (Id INT NOT NULL AUTOINCREMENT, NAME VARCHAR(255),PRIMARY KEY (ID)) ENGINE=InnoDB;

CREATE  TABLE IF NOT EXISTS AUDIT(Id INT NOT NULL AUTOINCREMENT, NAME VARCHAR(255),PRIMARY KEY (ID)) ENGINE=InnoDB;
